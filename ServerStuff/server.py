...
def sendOutput(stream_id, data, log, inputs=[], matrix=[], config_file='', outputs=[]):
...
class MatrixTransformServer(Server):
    ...
    def startSub(self, dataStream):
        ...
        sub.subscribe(dataStream, callback=sendOutput, inputs='A', matrix="B", config_file='origin-client.cfg', outputs="C")
